...
export async function POST(req: NextRequest) {
  ...
  // Attach includePrompt flag to Cloud Function request
  requestBody.includePrompt = includePrompt;
  ...
  // If includePrompt is true, always generate the prompt locally
  // regardless of whether the cloud function returns it
