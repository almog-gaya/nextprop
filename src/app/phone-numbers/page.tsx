...
export default function PhoneNumbersPage() {
  ...
  const [formData, setFormData] = useState({
    legalCompanyName: 'The Abdul Sattar Edhi International Foundation',
    dbaName: 'Bahadur',
    firstName: 'Bahadur',
    lastName: 'Zaman',
    ein: '113013369',
    einCountry: 'US',
    email: 'bahadurhere@gmail.com',
    phone: '18-639-5120',
    website: 'https://edhi.org/',
    termsPage: 'https://edhi.org/privacy-policy/',
    privacyPage: 'https://edhi.org/privacy-policy/',
    address: '45-11 National Street Corona',
    city: 'New York',
    state: 'NY',
    zip: '11368',
    country: 'US',
    campaignDescription: 'This campaign sends appointment information - confirmation & reminder messages to customers once they have booked an appointment with company_name on website and opted-in to receive promotional and notification SMS from company_name.',
    sampleMessage1: 'Hi John! This is Jane from company_name. Our appointment for July 20 11:00 AM is confirmed. Please reach out to +1(213) 725-2867 in case you need to reschedule. Reply STOP to unsubscribe.',
    sampleMessage2: `Hey Brian! This is Jane from company_name. I see that you weren't able to make it for our appointment. Would you like to reschedule? - https://www.mycompany.com/book. Reply STOP to unsubscribe.`,
    userConsentMethod: `End users opt-in by visiting - https://www.mycompany.com/book and filling in their details. Users check a box to receive notifications & promotional messages to provide their consent. Additionally end users can also text START to +1 (213) 725-2867.`,
    optInMessage: `You have successfully opted-in to receive notification and promotional SMS from company_name. Please reply STOP if you need to Opt-out in the future.`,
  });
