...
import { createA2PRegistration, updateA2PRegistration, getUserA2PRegistrations, A2PRegistration } from '@/lib/firebase/a2p';
...
export default function PhoneNumbersPage() {
  ...
  useEffect(() => {
    ...
    if (user?.locationId) {
      ...
      setIsLoading(true);
      unsubscribe = getUserA2PRegistrations(user.locationId, (registrations) => {
