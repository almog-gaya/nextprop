...
const navigation = [
  ...
  { name: 'Email Campaigns', href: '/emails/campaigns', icon: BarChart2 },
  { name: 'Campaign Analytics', href: '/emails/campaigns/analytics', icon: BarChart2 },
  { name: 'Contacts', href: '/contacts', icon: Users },
  { name: 'Settings', href: '/emails/settings', icon: Settings },
];
...
export function NavBar() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="md:hidden fixed inset-0 z-40 bg-gray-800 bg-opacity-90 flex items-center justify-center">
