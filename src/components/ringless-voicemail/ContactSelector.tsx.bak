      ...
      <div className="flex items-center space-x-2 mb-2">
        <div className="relative flex-1 border border-gray-300 rounded-lg">
          <input
            type="search"
            id="contact-search"
            className="w-full pl-6 pr-2 py-2.5 text-sm  rounded-lg bg-gray-50 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 placeholder-gray-400"
